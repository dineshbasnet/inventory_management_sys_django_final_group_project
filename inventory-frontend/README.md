...
|   |   |-- auth.js           (login, logout, user endpoints)
|   |   |-- users.js          (user management endpoints)
|   |   |-- products.js       (product and category endpoints)
|   |   |-- suppliers.js      (supplier endpoints)
|   |   |-- orders.js         (purchase order endpoints)
|   |   |-- stock.js          (stock management endpoints)
|   |   |-- reports.js        (dashboard and report endpoints)
|   |
|   |-- components/
